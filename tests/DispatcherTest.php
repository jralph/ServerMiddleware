...
class DispatcherTest extends TestCase
{
    ...
    public function testItPassesDownResponses()
    {
        $dispatcher = new Dispatcher();
    ...
    public function testItReturnsFirstFoundResponse()
    {
        $dispatcher = new Dispatcher();
    ...
    public function testItReturnsOverrideResponse()
    {
        $dispatcher = new Dispatcher();
    ...
    public function testItReturnsFirstFoundResponseFromLastMiddleware()
    {
        $dispatcher = new Dispatcher();
    ...
    public function testItReturns500ResponseIfNoMiddlewareIsAvailable()
    {
        $dispatcher = new Dispatcher();
...
class FirstResponse extends StubResponse {}
class SecondResponse extends StubResponse {}
